					...
					<div class="card mb-4 shadow rounded-4  custom-card-color" style="margin: 30px; padding: 20px">
						<div class="card-body">
							<div class="row">
								...
								<div class="col-sm-8">
									<p class="text-muted mb-0">Delvina Wongsono</p>
								</div>
							</div>
							<hr>
							<div class="row">
								...
								<div class="col-sm-8">
									<p class="text-muted mb-0">delvina.wongsono@binus.ac.id</p>
								</div>
							</div>
							<hr>
							<div class="row">
								...
								<div class="col-sm-8">
									<p class="text-muted mb-0">September 28</p>
								</div>
							</div>
							<hr>
							<div class="row">
								...
								<div class="col-sm-8">
									<p class="text-muted mb-0">Regression Analysis</p>
								</div>
							</div>
							<hr>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-8">
									<p class="text-muted mb-0">Hi! My name is Delvina Wongsono. You can call me Delvina or Del. I was born in Lubuk Pakam. I'm a college student at Binus University, majoring in Computer Science and Statistics. I am a dedicated, organized, and systematic individual. I have good interpersonal skills, am an excellent team worker, and am keen and very willing to learn and develop new skills. I am determined and decisive. I am outgoing and tactful, and able to listen effectively when solving problems.</p>
								</div>
							</div>
